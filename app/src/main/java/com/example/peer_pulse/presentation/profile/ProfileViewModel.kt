...
class ProfileViewModel @Inject constructor(
    ...
    private val _state2 = mutableStateOf<ResponseState<List<String>?>>(ResponseState.Success(emptyList()))
    val state2 : State<ResponseState<List<String>?>> = _state2


    private val _state3 = mutableStateOf<ResponseState<List<String>?>>(ResponseState.Success(emptyList()))
    ...
    fun updateFollowingPages(followingPageNames: List<String?>){
        userId?.let {
            viewModelScope.launch {
